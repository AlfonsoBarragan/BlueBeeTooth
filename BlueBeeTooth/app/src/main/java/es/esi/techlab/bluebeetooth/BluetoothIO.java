package es.esi.techlab.bluebeetooth;
...
import es.esi.techlab.bluebeetooth.model.ProfileBase;
...
public final class BluetoothIO extends BluetoothGattCallback {
     ...
     * @param profile Profile class which contains all the UUID from the services of the device that
     *                we wanna connect with the smartphone.
     */
    public BluetoothIO(BluetoothListener listener, ProfileBase profile) {
